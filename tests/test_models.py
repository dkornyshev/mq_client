...
class TestRabbitMQConfig:
    ...
    def stub_mq_config(self) -> functools.partial[models.RabbitMQConfig]:
        return functools.partial(
            ...
            broker_dsn='amqp://user:pass@mq.host:5672',
    ...
    def test_model(self, stub_mq_config: models.RabbitMQConfig) -> None:
        ...
        assert model.broker_dsn == 'amqp://user:pass@mq.host:5672/'
    ...
    def test_broker_dsn(
        ...
        assert mq_config.broker_dsn == validated_broker_dsn  # noqa: SIM300 (yoda-conditions)
    ...
    def test_broker_dsn_invalid(
        ...
        with pytest.raises(pydantic.ValidationError, match='broker_dsn'):
            stub_mq_config(broker_dsn=broker_dsn)
